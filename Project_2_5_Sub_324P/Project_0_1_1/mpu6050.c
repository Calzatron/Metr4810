 ...
 * mpu6050.c
 *
 * Created: 17/04/2017 10:34:37 PM
 *  Author: s4357594
 */ 
 ...
 */
void mpu6050_getConvData(info* info_ptr, double* axg, double* ayg, double* azg, double* gxds, double* gyds, double* gzds) {
	int16_t ax = 0;
	int16_t ay = 0;
	int16_t az = 0;
	int16_t gx = 0;
    ...
    *axg = (double)(ax)*g/MPU6050_AGAIN;
    *ayg = (double)(ay)*g/MPU6050_AGAIN;
    *azg = (double)(az)*g/MPU6050_AGAIN;
    *gxds = (double)(gx)*g/MPU6050_GGAIN;
	*gyds = (double)(gy)*g/MPU6050_GGAIN;
	*gzds = (double)(gz)*g/MPU6050_GGAIN;
