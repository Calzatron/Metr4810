 ...
 * mpu6050.h
 *
 * Created: 17/04/2017 10:36:22 PM
 *  Author: s4357594
 */ 
...
#define MPU6050_GETATTITUDE 0		///changed from 1
...
extern void mpu6050_getRawData(info* info_ptr, int16_t* ax, int16_t* ay, int16_t* az, int16_t* gx, int16_t* gy, int16_t* gz);
extern void mpu6050_getConvData(info* info_ptr, double* axg, double* ayg, double* azg, double* gxds, double* gyds, double* gzds);
#endif
